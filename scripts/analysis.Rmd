...
grass --tmp-location /hdd/Geospatial_data/sunhours/input/UFO_dem_10_smooth.tif
...
```{r}
terra::rast('/hdd/Geospatial_data/sunhours/input/UFO_dem_10_smooth.tif') # nad83
terra::rast('/hdd/Geospatial_data/sunhours/input/UFO_aspect.tif') # nad83
terra::rast('/hdd/Geospatial_data/sunhours/input/UFO_slope.tif')
