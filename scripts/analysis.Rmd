...
# drought_vars <- filter(drought_vars, CellID == 1)
...
pen <- penman(Tmin = drought_vars$tmin, Tmax = drought_vars$tmax,
       U2 = drought_vars$vs, # wind speeds
       lat = drought_vars$y[1], #
       Rs = NA, Ra = NA, # but could get  both from r.sun ??
       tsun = drought_vars$sunhours, # CC = drought_vars$cloudcover,
       z = drought_vars$elevation[1], na.rm = TRUE)
